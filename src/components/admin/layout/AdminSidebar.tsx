...
export default function AdminSidebar() {
  ...
  return (
    <aside className="w-60 min-h-screen bg-bg-surface border-r border-border-default flex flex-col">
      {/* Logo */}
      ...
      {/* Nav */}
      <nav className="flex-1 p-3 space-y-0.5" aria-label="Admin menü">
